...
| **17.10B. Project Membership Backfill** | ⏳ | Chờ duyệt. Artifact backfill đã chuẩn bị riêng cho 6 membership rows đã review bằng project/employee ID: Owner employee 3, Project Manager employee 4, Creative Lead employee 6 cho project 1 và 2. Chưa chạy SQL backfill. | `Backfill 6 rows chỉ chạy sau duyệt riêng.` | Duyệt Project Membership Backfill. |
